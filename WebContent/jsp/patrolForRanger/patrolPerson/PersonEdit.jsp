...
/* #hideThis{background-color:#CCC}  .layui-table tbody tr:hover,.layui-table-hover, */
...
<body>
<div style="padding:3px 0 0 5px;width:664px;">
		...
		<tbody >
			<tr>
				...
				<td id="nationalityTd" style="padding:0;width:70px;align:left;cursor:pointer;">
					<input id="nationality" type="text" readonly style="cursor:pointer;width:50px;border:0;background-color:transparent;text-align:center;"/>
				...
				<td style="padding:0; width:70px;"><input  id="age" type="text" style="width:50px;border:0;background-color:transparent;text-align:center;"><button style="width:12px;height:12px;border:0;background-color:transparent;"></button><span style="position:absolute; top:2px; right:10px;width:20px;height:20px; border:0;">岁</span></td>	
			</tr>
			<tr>
				...
				<td colspan="3" style="padding:0;width:230px;"><input  id="idcode" type="text" maxlength="18" style="width: 230px;border:0;background-color:transparent;text-align:center;"readonly></td>
				<td class="colorF2">出生年月</td>
				<td style="padding:0;width:79px;height:27px;"><input  id="birthday" type="text" style="width:79px;height:27px;border:0;color:#888888;background-color:transparent;text-align:center;"readonly></td>
			</tr>
			 <tr>
			...
			<tr>
				...
				<td colspan="3" style="padding:0;"><select  id="educated" style="width:220px; border:0;background-color:transparent;align:center;">
					...
					<option value="5" selected>初中</option>
					<option value="6">小学</option>
					<option value="7">文盲</option>
				</select></td>
	...
	<table id="tabletwo" class="layui-table" lay-size="sm" style="margin:-1px 0 5px 0;">
		<tbody>
			...
			<tr>
				...
				<td style="padding:0;"><input placeholder="不超过20个汉字" id="patrolPlace" type="text" style="width: 130px;border:0;background-color:transparent;text-align:center;"></td>
		...
		<tbody>
			...
			<tr>
				...
				<td style="padding:0;"><select  id="employState" style="width:80px; border:0;background-color:transparent;align:center;">
					<option value="1">选聘</option>
					<option value="2">续聘</option>
					<option value="3">解聘</option>
				</select></td>
			...
			<tr id="hideThis">
				...
				<td colspan="3" style="padding:0;"><select   id="unemployReason" style="width:317px;border:0;background-color:transparent;align:center;" >
					<option value="99">其它</option>
					<option value="2">已脱贫</option>
					<option value="3">分户</option>
					<option value="4">刑拘</option>
					<option value="5">外出务工</option>
					<option value="6">生病</option>
					<option value="7">脱岗</option>
					<option value="8">考核不合格</option>
					<option value="9">自愿退出</option>
					<option value="10">违反管理办法</option>
					<option value="1">死亡</option>
				</select>
				<td class="colorF2">解聘日期</td>
				<td colspan="3" style="padding:0;"><input   id="unEmployDate" style="width:200px;border:0;background-color:transparent;text-align:center;" readonly></td>
			</tr>
			<tr>
...
<div style="position:absolute; top:23px; right:6px;width:130px;height:160px;text-align:center;border:#D3D3D3 solid 1px;">
	<div id="preview"><img id="imghead" border="0" src="../../../images/photo_icon.png"
										width="130" height="160" onclick="$('#previewImg').click();">
...
<script type="text/javascript" src="/ResourceMonitor/js/myJS/patrolForRanger/patrolPerson/PersonEdit.js"></script>
</html>