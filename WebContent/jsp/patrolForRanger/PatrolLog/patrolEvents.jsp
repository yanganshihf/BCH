				...
				<div class="tab-pane active" id="panel-851281">
					<form class="form-inline" id="formDiv">
						...
						<div class="form-group" style="display:none">
							<label for="projectType">&emsp;工程类别</label> <select
						...
						<div class="form-group">
							<label for="startDatePicker">&emsp;开始日期</label> <input
								...
								id="startDatePicker" value="2017-12-31" />
						</div>
						<div class="form-group">
						...
						<button type="button" class="btn btn-default" id="submit"
							...
							<button type="button" class="btn btn-default" id="analysis"
								style="float: right;margin-right:15px;display:none" title="智能分析">
								<img src="/ResourceMonitor/images/indexpage/send.png" class=""
									alt="xiazai">
							</button>
					</form>
...
$(function(){
	...
	if(menus.indexOf("导出事件") == -1){
		$("#excel").css("display","none");
	}
})
</script>
<script type="text/javascript"
	src="/ResourceMonitor/js/myJS/patrolForRanger/PatrolLog/patrolEvents.js"></script>
</html>