...
<body>
	<div>
		<table style="font-size:14px;line-height:35px;margin-top:8px;margin-left:5px;text-align:left">
			<tbody>
				<tr>
					<td style="text-align:right;width:110px;"><label style="margin-right:10px;">坐标格式</label></td> 
				...
				<tr>
					<td style="text-align:right;width:110px;"><label style="margin-right:10px;">分析方式</label></td> 
			    	<td colspan="3">
				...
				<tr>
					<td style="font-weight:bold"><span style="margin-left:45px;">起点坐标</span></td>
					<td colspan="3">
						<input type="checkbox" id="screenStart" style="margin-left:10px;" onchange="onScreenStart()"/>屏幕选点
				    	<button type="button" id ="openEventStart" style="margin-left:10px;background-color:#058563;border-color:#058563;" class="btn btn-primary btn-sm" onclick="openEventStart()">选择已录入事件</button>
				    </td>
				</tr>				
				<tr id="longtSTR">
					<td style="text-align:right"><label style="margin-right:10px;font-weight:normal">起点经度</label></td>
				...
				<tr id="latSTR">
					<td style="text-align:right"><label style="margin-right:10px;font-weight:normal">起点纬度</label></td>
				...
				<tr>
					<td style="font-weight:bold"><span style="margin-left:45px;">终点坐标</span></td>
					<td colspan="3">
						<input type="checkbox" id="screenEnd" style="margin-left:10px;" onchange="onScreenEnd()"/>屏幕选点
				    	<button type="button" id ="openEventEnd" style="margin-left:10px;background-color:#058563;border-color:#058563;" class="btn btn-primary btn-sm" onclick="openEventEnd()">选择已录入事件</button>
				    </td>
				</tr> 				
 				<tr id="longtETR">
					<td style="text-align:right"><label style="margin-right:10px;font-weight:normal">终点经度</label></td>
				...
				<tr id="latETR">
					<td style="text-align:right"><label style="margin-right:10px;font-weight:normal">终点纬度</label></td>
	...
	<script>
		...
		function onCoorTypeChanged(){
			...
			if(locationType=="optionDMS"){
				...
				$("#openEventStart").attr("disabled",false);
				$("#openEventEnd").attr("disabled",false);
				...
				$("#openEventStart").attr("disabled",true);
				$("#openEventEnd").attr("disabled",true);
				$("#longtSTR").html(longtSHtmlEnable);
				$("#latSTR").html( latSHtmlEnable);
				$("#longtETR").html(longtEHtmlEnable);
				$("#latETR").html( latEHtmlEnable);
...
//--------------------------------------------------------------------------------
		function sumbit(){
			...
			parent.analysis.funDoRouteAna(routeAnaParams);
		}
