				...
				<div class="tab-pane active" id="panel-851281">
					<form class="form-inline" id="formDiv">
						<div class="form-group">
							<label for="stationNum">&emsp;基站编号</label> <input id="stationNum"
								class="form-control" />
						</div>
						<div class="form-group">
							<label for="stationPlace">&emsp;基站地点</label> <input id="stationPlace"
								class="form-control" />
						</div>
...
<script type="text/javascript"
	src="/ResourceMonitor/js/myJS/monitorForVideo/Alarm/Alarm.js"></script>
</html>