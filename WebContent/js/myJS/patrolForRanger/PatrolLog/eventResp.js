$(function() {
		...
		$.ajax({
			...
			success : function(req) {
				...
				$("#eventText").html(thisEve.eventText);
				$("#happenTime").html(thisEve.happenTime);
				$("#reportPeople").html(thisEve.reportPeople);
				$("#departmentCode").html(thisEve.departmentCode);
				$("#projectType").html(thisEve.projectType);
				$("#longitude").html(thisEve.longitude);
				$("#latitude").html(thisEve.latitude);
				$("#xCoor").html(thisEve.xCoor);
				$("#yCoor").html(thisEve.yCoor);
				$("#uploadTime").html(thisEve.uploadTime);
...
function vedioPlayer(){
	...
	/*var vedioPlayer = layer.open({
		...
		area : ['642px','438px'],
		resize : false,
		content : 'vedioPlayer.jsp?'+encodeURI(vedioName)
	});*/
...
function redioPlayer(){
	...
	var redioPlayer = layer.open({
		...
		area : ['642px','438px'],
		resize : false,
		content : 'vedioPlayer.jsp?'+encodeURI(redioName)
	});*/
