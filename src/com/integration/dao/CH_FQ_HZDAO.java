 ...
 *
 */
public interface CH_FQ_HZDAO {
	@Delete("delete from YHSWXC_BZD_CHHZ_FQ where UUID = #{0}")
	void delete(String uuid);
	
	@Select("select t0.SHI,t0.XIAN,t0.YANGDI_H,t1.* from YHSWXC_BZD t0,YHSWXC_BZD_CHHZ_FQ t1 \r\n" + 
	...
	List<YhswxcBzdChhzFq> queryList(String shi, String xian, String xiang, String yangdi_h, String shouhai_zlStr);
	
	@Select("select t0.SHI,t0.XIAN,t0.YANGDI_H,t1.* from YHSWXC_BZD t0,YHSWXC_BZD_CHHZ_FQ t1 \r\n" + 
			"WHERE t0.UUID_BZD = t1.UUID_BZD  "
			+ "and t1.UUID_BZD = #{0}")
	List<YhswxcBzdChhzFq> findById(String UUID_BZD);
	
	@Update("update YHSWXC_BZD_CHHZ_FQ set uuid_bzd =#{1},yhsw_lb=#{2},yhsw_mc =#{3},"
